...
DROP TABLE IF EXISTS `add_reward`;
CREATE TABLE IF NOT EXISTS `add_reward` (
...
DROP TABLE IF EXISTS `external_advertisement`;
CREATE TABLE IF NOT EXISTS `external_advertisement` (
...
DROP TABLE IF EXISTS `vacany_add`;
CREATE TABLE IF NOT EXISTS `vacany_add` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
